 ...
 */
public class CefBrowserOsr extends CefBrowser_N implements CefRenderHandler {// implements CefRenderHandler, IBrowser {
...
//    @Override
    public void injectKeyPressedByKeyCode(int keyCode, int mods) {
        KeyEvent ev = new KeyEvent(dc_, KeyEvent.KEY_PRESSED, 0, mods, keyCode);
        sendKeyEvent(ev);
    }
